...
export const getActiveBoardName = (state: RootState) => state.data.activeBoard.name;
...
export const getSelectedColumn = (state: RootState) => state.data.selectedColumn;
...
export const getCompletedSubtasksOnSelectedTask = createSelector(getSelectedTask, (selectedTask) =>
